...
export const routes: Routes = [
  ...
  { path: 'recuperar-contraseña', component: RecuperarPasswordComponent },
  {
    ...
    children: [
      ...
      { path: 'categorias/nuevo', loadComponent: () => import('./features/categorias/categoria-nuevo/categoria-nuevo.component').then(m => m.CategoriaNuevoComponent), canActivate: [denyVendedorGuard] },
      { path: 'categorias/:id/editar', loadComponent: () => import('./features/categorias/categoria-editar/categoria-editar.component').then(m => m.CategoriaEditarComponent), canActivate: [denyVendedorGuard] },
